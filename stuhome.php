  ...
  <header id="header">
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          <li class="menu-active"><a href="stuhome.php">Home</a></li>
          <li><a href="post1.php">Alumni Post</a></li>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-5 features-img">
			...
			?>
			<!--<br><a href="profile_pic2.php#about">Profile Picture</a>-->
          </div>
          ...
          <div class="col-lg-8 col-md-7 ">
            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-md-6 box" data-aos="fade-left" data-aos-delay="200">
                ...
                <p class="description"><?php echo $row['degree']."-".$row['dept'].", Batch: ".$row['batch']; ?>
              ...
              <div class="col-lg-6 col-md-6 box" data-aos="fade-left" data-aos-delay="300">
                ...
                <h4 class="title"><a href="">Education</a></h4>
                 <p class="description"><?php echo $row['year']; ?>

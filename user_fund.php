            ...
            <div class="form">
              ...
              <form action="" method="post" name="form" enctype="multipart/form-data">
				...
				<div class="form-group">
                  <textarea class="form-control" name="uname"></textarea>
				  
                </div>
                <div class="text-center">
                  <p><span class="form-group">
                    <textarea class="form-control" name="fund"></textarea>
                  </span> </p>
                  <p>
			  ...
			  if(isset($btn))
			  {
			  	$mq=mysql_query("select max(id) from user_fund");
	$mr=mysql_fetch_array($mq);
	$id=$mr['max(id)']+1;
	
	$ins=mysql_query("insert into user_fund(id,uname,fund,rdate) values($id,'$uname','$fund','$rdate')");
	//echo "Post Uploaded Successfully";
	?>
	<script language="javascript">
	window.location.href="user_fund.php";
	</script>
	<?php
			  }
			  ?>

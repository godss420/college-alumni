        ...
        <div class="row" data-aos="fade-up">
          ...
          <div class="col-lg-5 col-md-8">
            <div class="form">
			  ...
			  $qry=mysql_query("select * from student $q");
			  while($row=mysql_fetch_array($qry))
			  {
			  ?>
			  <table width="333" border="1">
			  <tr>
			    <td colspan="4" class="alert-danger"><?php echo $row['name']." (".$row['regno'].")"; ?></td>
			    </tr>
			  <tr>
			  ...
			  <tr>
			    ...
			    <td align="left" class="alert-secondary">City</td>
			    <td align="left"><?php echo $row['city']; ?></td>
			    </tr>
			  <tr>
			    <td align="left" class="alert-secondary">Year</td>
			    <td align="left"><?php echo $row['year']; ?></td>
			    <td align="left" class="alert-secondary">Batch</td>
			    <td align="left"><?php echo $row['batch']; ?></td>
			    </tr>
			  <tr>

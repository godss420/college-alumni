        ...
        <div class="row" data-aos="fade-up">
          ...
          <div class="col-lg-5 col-md-8">
            <div class="form">
              ...
              <form action="" method="post" name="form">
				...
				<div class="form-row">
                  <div class="form-group col-lg-6">
                    <input type="text" name="degree" class="form-control" id="degree" placeholder="Degree" />
                  </div>
                  <div class="form-group col-lg-6">
				...
				<div class="form-group">
                 <input type="text" name="year" class="form-control" id="year" placeholder="Year of Passing" />
                </div>
			  ...
			  if(isset($btn))
			  {
			  $mq=mysql_query("select max(id) from education");
			  $mr=mysql_fetch_array($mq);
			  $id=$mr['max(id)']+1;
			  $ins=mysql_query("insert into education(id,uname,degree,college,location,year) values($id,'$uname','$degree','$college','$location','$year')");
			  ?>

   ...
   <!-- #faq -->
    ...
    <section id="gallery">
      <div class="container-fluid">
        <div class="section-header">
          ...
          <span class="section-divider"></span>
          <p class="section-description">Admin Control</p>
        </div>
	...
	$msg="";
			...
			$n1=mysql_num_rows($q1);
				...
				window.location.href="admin_stu.php";
				</script>
				<?php
				}
				else
            ...
            <div class="form">
              ...
              <form action="" method="post" name="form">
				...
				<div class="form-group">
                  <input type="text" class="form-control" name="uname" id="uname" placeholder="Username" data-rule="minlen:4" data-msg="Please enter at least 4 chars of subject" />

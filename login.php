    ...
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li class="menu-active"><a href="login.php#login">Alumini</a></li>
  ...
  <main id="main">
   ...
   <!-- #faq -->
    ...
    <section id="gallery">
      <div class="container-fluid">
        <div class="section-header">
          <h3 class="section-title">Member Login</h3>
          <span class="section-divider"></span>
          <p class="section-description">Alumni Members Login here</p>
        </div>
	...
	$msg="";
			if(isset($btn))
			{
			$q1=mysql_query("select * from register where regno='$uname' && pass='$pass'");
            ...
            <div class="form">
              ...
              <form action="" method="post" name="form">
				...
				<div class="form-group">
                  <input type="text" class="form-control" name="uname" id="uname" placeholder="Username/Reg No." data-rule="minlen:4" data-msg="Please enter at least 4 chars of subject" />
                  <div class="validation"></div>
                </div>
                <div class="form-group">
                  <input type="password" class="form-control" name="pass" id="pass" placeholder="Password" data-rule="minlen:4" data-msg="Please enter at least 4 chars of subject" />
                  <div class="validation"></div>
                </div>
                <div class="text-center"><input type="submit" name="btn" value="Login"></div>
				<div><a href="register.php#register">New Member Register here</a></div>
              </form>
            </div>
          </div>
